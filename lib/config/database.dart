...
const String USERS_QUERY = "CREATE TABLE users ("
    "username TEXT PRIMARY KEY,"
    "email TEXT UNIQUE NOT NULL,"
    "password TEXT NOT NULL"
    ");";

const String INGREDIENTS_QUERY = "CREATE TABLE ingredients ("
    "name TEXT PRIMARY KEY"
    ");";

const String USED_INGREDIENTS_QUERY = "CREATE TABLE used_ingredients ("
...
const String OWNED_INGREDIENTS_QUERY = "CREATE TABLE owned_ingredients ("
    "ingredient TEXT NOT NULL,"
    "amount REAL NOT NULL,"
    "measurement_unit TEXT NOT NULL,"
    "owner TEXT NOT NULL,"
...
const String RECIPES_QUERY = "CREATE TABLE recipes ("
