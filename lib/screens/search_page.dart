...
class _SearchPageState extends State<SearchPage> {
  ...
  SearchMethod? _searchMethod = SearchMethod.insertNewIngredients;
    ...
    return MingleScaffold(
      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          var allowed = snapshot.hasData && snapshot.data == true;
            ...
            child: Column(
              children: [
                ...
                MingleLargeButton(
                    label: "Buscar",
                    onClick: () =>
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => AllRecipesPage(future: handleSearch()))))
              ],
            ),
          );
        },
...
class SearchOption extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(borderRadius: BorderRadius.circular(16.0), color: disabled ? Colors.grey : Color(0xFFDADADA)),
        child: InkWell(
