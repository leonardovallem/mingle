...
void main() {
  ...
  List<Recipe> recipes = [
    Recipe(
        ...
        averageRating: 4.5,
        photo:
            "https://i1.wp.com/www.flamboesa.com.br/wp-content/uploads/2017/10/brigadeiro-doce-de-leite4072.jpg"),
    Recipe(
        name: "Sopa de cebolinha",
        publisher: "anav_andrade",
        averageRating: 4.6,
        photo:
            "https://t1.uc.ltmcdn.com/pt/images/6/3/8/img_como_fazer_caldo_verde_7836_orig.jpg"),
    Recipe(
        name: "Suco roxo",
        publisher: "joaovictormarques",
        averageRating: 3.9,
        photo:
            "https://xtudoreceitas.com/wp-content/uploads/Sucos-Detox-Beterraba-500x400.jpg"),
    Recipe(
        name: "Escondidinho de brócolis",
        publisher: "mariavitorias",
        averageRating: 4.1,
        photo:
            "http://3.bp.blogspot.com/-kGs1anoEMsM/VL0dlYfhlUI/AAAAAAAADQw/gQZjXMg9-rs/s1600/escondidinho_brocolis.JPG"),
  ];
